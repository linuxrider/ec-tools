r"""
---------------------------------------------
 Benchmark with Python code & transonic (pythran backend)
---------------------------------------------
"""
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(y, x, alg="frlt", transonic_backend="pythran"),
            x,
            alg="frlt",
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(y, x, alg="g1", transonic_backend="pythran"),
            x,
            alg="g1",
            transonic_backend="pythran",
        )
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(y, x, alg="r1", transonic_backend="pythran"),
            x,
            alg="r1",
            transonic_backend="pythran",
        )
